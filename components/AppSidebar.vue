...
import { useConversationsStore } from '~/stores/conversations'; // Import useConversationsStore
import BingIcon from '~/components/Icons/BingIcon.vue';
import GPTIcon from '~/components/Icons/GPTIcon.vue';
import { useRouter } from 'vue-router';
import { ref, computed, nextTick } from 'vue'; // Import ref, computed, and nextTick if not already imported
...
const conversationsStore = useConversationsStore(); // Define conversationsStore using useConversationsStore
const {
        ...
        <div class="p-3 pb-0">
            ...
            >
                    <span class="flex flex-col flex-1 text-left">
                        <span class="text-sm font-bold text-white/80">切换GPT模型</span>
